...
namespace ForEx.Reports {
    ...
    public class DailyTransac0 : ReportClass {
        
        public DailyTransac0() {
        }
        
        public override string ResourceName {
            get {
                return "DailyTransac0.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "ForEx.Reports.DailyTransac0.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedDailyTransac0 : Component, ICachedReport {
        
        public CachedDailyTransac0() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            DailyTransac0 rpt = new DailyTransac0();
            rpt.Site = this.Site;
            return rpt;
        }
